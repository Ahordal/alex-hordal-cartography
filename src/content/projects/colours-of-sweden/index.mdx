...
description: "A responsive SVG-based thematic web map exploring Swedish provincial heraldry through the ai2html Adobe Illustrator plugin, interactive vector graphics, semantic HTML/CSS structure, and custom DOM-based interaction."
